...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    author: "Dr. Dédé Tetsubayashi",
    content: [
      "Juneteenth—June 19, 1865—marks the day that enslaved people in Galveston, Texas finally learned of their freedom, more than two years after the Emancipation Proclamation. The delay was not accidental; it was a deliberate withholding of information to extend the period of exploitation.",
      "This history holds profound lessons for today. The spirit of Juneteenth is acknowledgement—acknowledgement of the brutal truth of slavery, acknowledgement of the ongoing legacy of that brutality, and acknowledgement of Black humanity and the right to freedom.",
      "When Juneteenth became a federal holiday in 2021, it was a moment of acknowledgement. But acknowledgement without action is hollow. The same Congress that voted to recognize Juneteenth has failed to pass meaningful legislation addressing voting rights, police violence, and economic inequality.",
      "In tech, we see similar patterns of acknowledgement without action. Companies issue statements in support of Black lives while maintaining discriminatory AI systems, inequitable hiring practices, and products that cause disproportionate harm to Black communities.",
