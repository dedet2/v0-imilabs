          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative h-96 w-full mb-12 rounded-xl overflow-hidden">
              <Image
                ...
                alt="Consumer Goods Market Discovery"
                fill
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed">
                "We thought we were data-driven. We had sophisticated AI systems analyzing consumer behavior, predicting
                trends, and optimizing our product recommendations. But we were completely missing 15% of the global
                market—the disability community, representing $300M in annual revenue we were leaving on the table."
              </p>
              <p className="text-lg leading-relaxed">
              ...
              <p className="text-lg leading-relaxed">
                "Dr. Tetsubayashi's presentation at our annual strategy retreat was a wake-up call. She showed us data
                we'd never seen: the disability market's $13 trillion in global purchasing power, the 1.3 billion people
                we were excluding, and most importantly, how our competitors were starting to capture this opportunity."
              </p>
              <p className="text-lg leading-relaxed">
                "What started as a compliance discussion became a growth strategy conversation. She reframed inclusive
                AI not as a cost center but as a market expansion opportunity. The board was immediately interested."
              </p>

              <h2>The Transformation</h2>
              <p className="text-lg leading-relaxed">
                "Dr. Tetsubayashi led a comprehensive redesign of our AI systems with accessibility at the core. We
                retrained our recommendation algorithms, rebuilt our customer segmentation models, and redesigned our
                entire digital experience with universal design principles."
              </p>
              <p className="text-lg leading-relaxed">
                ...
                consultants with disabilities, conducted extensive user research, and built inclusive design into our
                product development process."
              </p>

              <h2>The Results</h2>
              <p className="text-lg leading-relaxed">
                "The results exceeded every expectation. Within 18 months, we were reaching 45 million consumers across
                23 markets we'd previously ignored. Revenue from these segments grew to $300M annually—pure incremental
                growth we would have missed without Dr. Tetsubayashi's guidance."
              </p>
              <p className="text-lg leading-relaxed">
                "But the impact went beyond revenue. Our brand reputation soared. We won multiple awards for inclusive
                innovation. Our employee engagement scores improved as our teams felt proud of building products that
                served everyone. And our stock price reflected the market's confidence in our growth strategy."
              </p>
              ...
              <p className="text-lg leading-relaxed">
                "If you're leaving money on the table by ignoring the disability market, you can't afford to wait. Dr.
                Tetsubayashi's expertise can help you turn inclusive AI from a cost center into a growth engine."
              </p>
            </div>
