...
import { ArrowRight, Shield, Heart, Mic, CheckCircle2, TrendingUp, Users, Award } from "lucide-react"
import { StructuredData } from "@/components/structured-data"
import { generateStructuredData, generateOrganizationStructuredData } from "@/lib/seo"
import Image from "next/image"

export default function HomePage() {
  const personData = generateStructuredData({
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <Card className="text-center bg-white/80 backdrop-blur-sm border-purple-100">
              <CardHeader>
                <CardTitle className="text-3xl font-bold text-purple-600">$200M+</CardTitle>
                <CardDescription>Cost Savings Generated</CardDescription>
              </CardHeader>
            </Card>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-purple-100 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed italic">
                    "Dr. Dédé's expertise in AI governance transformed our approach to healthcare technology. Her
                    insights helped us achieve 95% improvement in diagnostic accuracy while ensuring ethical AI
                    practices."
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-purple-100 hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed italic">
                    ...
                    Her luxury retreats provided our leadership team with invaluable insights and actionable
                    strategies."
                  </p>
                </CardContent>
              </Card>
